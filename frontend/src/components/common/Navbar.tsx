...
import { HamburgerMenu } from "../Navbar/HeaderHelper"
...
const ProblemNavbar = () => {
  ...
  return (
    <div
      className={`w-full  border-b border-n-6 lg:bg-s1 lg:backdrop-blur-sm ${openNavigation ? "bg-s1" : "bg-n-8/90 backdrop-blur-sm"
        }`}
    >
