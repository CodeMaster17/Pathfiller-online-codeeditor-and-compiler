...
const Footer = () => {
  return (
    <footer className="text-white body-font bg-black  pt-28">
  <div className="container px-5 py-20 mx-auto border-t border-gray-400">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
          <div className="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
            <label className="leading-7 text-sm text-white">Placeholder</label>
  ...
  <div>
    <div className="container px-5 pb-6 mx-auto flex items-center sm:flex-row flex-col">
