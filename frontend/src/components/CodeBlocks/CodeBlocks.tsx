...
const CodeBlocks = ({
  ...
  return (
    <div className={`flex ${position} justify-between gap-10 bg-black p-28 `}>
      ...
      <div className="code-border border rounded-lg bg-gray-900 flex flex-row py-16 px-8 text-[10px] sm:text-sm leading-[18px] sm:leading-6 relative w-full lg:w-[470px]">
