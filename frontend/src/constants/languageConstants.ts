...
export const LANGUAGE_CONFIG_CONSTANT: LanguageConfig = {
  javascript: {
    id: "javascript",
    label: "JavaScript",
    logoPath: "/languages/javascript.png",
...
console.log('Sum of numbers:', sum);`,
  ...
  typescript: {
    id: "typescript",
    label: "TypeScript",
    logoPath: "/languages/typescript.png",
